    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (request.getParameter("op")) {
            case "update":
                ...
                persona = (Persona) gdao.getById(Integer.parseInt(request.getParameter("id")), Persona.class);
                persona.setNombre(request.getParameter("nombre"));
                if (request.getParameter("libro1") != null) {
                    if (request.getParameter("idLibro1") != null && request.getParameter("libro1").length() > 0) {
                        libro = (Libro) gdao.getById(Integer.parseInt(request.getParameter("idLibro1")), Libro.class);
                    } else {
                        libro = new Libro();
                    }
                ...
                if (request.getParameter("libro2") != null) {
                    if (request.getParameter("idLibro2") != null && request.getParameter("libro2").length() > 0) {
                        libro = (Libro) gdao.getById(Integer.parseInt(request.getParameter("idLibro2")), Libro.class);
                    } else {
                        libro = new Libro();
                    }
                ...
                if (request.getParameter("libro3") != null) {
                    if (request.getParameter("idLibro3") != null && request.getParameter("libro3").length() > 0) {
                        libro = (Libro) gdao.getById(Integer.parseInt(request.getParameter("idLibro3")), Libro.class);
                    } else {
                        libro = new Libro();
                    }
