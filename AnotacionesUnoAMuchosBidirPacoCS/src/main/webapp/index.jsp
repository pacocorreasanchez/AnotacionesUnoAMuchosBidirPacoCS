        ...
        <div id="principal">
            <center>
                ...
                <div id="menuPrincipal">
                    ...
                    <li><a href="${contexto}/Eleccion?op=list" class="enlace">Listar por personas</a></li>
                    <li><a href="${contexto}/Eleccion?op=listLibros" class="enlace">Listar por libros</a></li>
